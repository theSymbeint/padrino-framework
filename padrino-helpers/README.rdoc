...
three output helpers worth mentioning: <tt>content_for</tt> and <tt>capture_html</tt>
...
The capture_html methods allow content to be manipulated and stored for use in building
